...
scale =
    [ animateTransform [ type_ "scale", to "1 1", calcMode "spline", keySplines "0.1 0.8 0.51 0.95", keyTimes "0;0.2", begin "logo.mouseenter+0.1s", end "logo.mouseleave", dur "0.2s", attributeName "transform", fill "freeze", additive "sum" ] []
    , animateTransform [ type_ "scale", to "0 1", calcMode "spline", keySplines "0.1 0.8 0.51 0.95", keyTimes "0;0.2", begin "logo.mouseleave+0.1s", dur "0.2s", attributeName "transform", fill "freeze" ] []
    ]


translate =
    [ animateTransform [ type_ "translate", to "0 0", calcMode "spline", keySplines "0.1 0.8 0.51 0.95", keyTimes "0;0.2", begin "logo.mouseenter+0.1s", end "logo.mouseleave", dur "0.2s", attributeName "transform", fill "freeze", additive "sum" ] []
    , animateTransform [ type_ "translate", to "60 0", calcMode "spline", keySplines "0.1 0.8 0.51 0.95", keyTimes "0;0.2", begin "logo.mouseleave+0.1s", dur "0.2s", attributeName "transform", fill "freeze" ] []
    ]
...
animated =
    svg [ viewBox "0 0 119 45", id "logo", fill "white" ]
        ...
        , g
            [ id "Note"
            , transform "translate(-15, 10) scale(0.5 0.5)"
            ]
            [ Svg.path
                [ id "Croche"
                , fill (Element.toHex palette.text)
